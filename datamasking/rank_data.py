...
RANK_DECLENSIONS = {
    ...
    'мастер-сержант': {
        'nominative': 'мастер-сержант',
        'genitive': 'мастер-сержанта',
        'dative': 'мастер-сержанту',
        'instrumental': 'мастер-сержантом',
    },
    'штабс-сержант': {
        'nominative': 'штабс-сержант',
        'genitive': 'штабс-сержанта',
        'dative': 'штабс-сержанту',
        'instrumental': 'штабс-сержантом',
    },
    'майстер-сержант': {
        'nominative': 'майстер-сержант',
        'genitive': 'майстер-сержанта',
        'dative': 'майстер-сержанту',
        'instrumental': 'майстер-сержантом',
    },
    'старший майстер-сержант': {
        'nominative': 'старший майстер-сержант',
        'genitive': 'старшого майстер-сержанта',
        'dative': 'старшому майстер-сержанту',
        'instrumental': 'старшим майстер-сержантом',
    },
    'головний майстер-сержант': {
        'nominative': 'головний майстер-сержант',
        'genitive': 'головного майстер-сержанта',
        'dative': 'головному майстер-сержанту',
        'instrumental': 'головним майстер-сержантом',
    },
